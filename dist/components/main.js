...
var _popWebsites = __webpack_require__(38);

var _popWebsites2 = _interopRequireDefault(_popWebsites);

var _historyList = __webpack_require__(54);
...
var store = new _vuex2.default.Store({
    state: _extends({}, _popWebsites2.default.state, _historyList2.default.state),
    actions: _extends({}, _popWebsites2.default.actions, _historyList2.default.actions),
    getters: _extends({}, _popWebsites2.default.getters, _historyList2.default.getters),
    mutations: _extends({}, _popWebsites2.default.mutations, _historyList2.default.mutations)
});
...
Object.defineProperty(_vue2.default.prototype, '$axios', { value: _axios2.default }); /**
                                                                                       * 入口
...
exports.default = {
    ...
    actions: {
        getSites: function getSites(_ref) {
            var commit = _ref.commit;

            commit(types.SET_SITES, [{ title: '必应', url: 'http://cn.bing.com' }, { title: '百度', url: 'http://www.baidu.com' }, { title: '', url: '' }]);
        }
    },
    getters: {
    ...
    mutations: _defineProperty({}, types.SET_SITES, function (state) {
        var sites = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
...
var _Popwebsites = __webpack_require__(47);

var _Popwebsites2 = _interopRequireDefault(_Popwebsites);

var _HistoryList = __webpack_require__(53);
...
exports.default = {
    name: 'popWebsites',
    computed: _extends({}, (0, _vuex.mapGetters)(['sites'])),
    methods: _extends({}, (0, _vuex.mapActions)(['getSites'])),
    render: function render(h) {
        var _this = this;
        return h(
            'div',
    ...
    render: function render(h) {
        ...
        return h(
            ...
            [h(
                'input',
                {
                    attrs: { id: 'search', type: 'text', placeholder: 'search', value: _this.inputVal,
                        autocomplete: 'off'
                    },
                    'class': 'search__input', on: {
...
exports.default = {
    name: 'HistoryList',
    computed: _extends({}, (0, _vuex.mapGetters)(['history'])),
    methods: _extends({}, (0, _vuex.mapActions)(['getHistory'])),
    render: function render(h) {
        var _this = this;
        return h(
            'ul',
            ...
            [_this.history.map(function (history) {
                return h(
                    ...
                    [h(
                        'a',
                        { 'class': 'history_item__title text-ellipsis', attrs: { href: history.url, title: history.title }
                        },
                        [history.title]
                    ), h(
                        'a',
                        { 'class': 'history_item__url text-ellipsis', attrs: { href: history.url, title: history.title }
                        },
                        [history.url]
                    )]
                );
...
exports.default = {
    ...
    mutations: _defineProperty({}, types.GET_HISTORY, function (state) {
